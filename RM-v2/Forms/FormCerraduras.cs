...
namespace RM_v2.Forms
{
    public partial class FormCerraduras : Form
    {
        ...
        private void ActualizarGrilla()
        {
            ...
            dataGridViewCerradura.DataSource = accesoriosGrid;
        }
        ...
        public FormCerraduras()
        {
            ...
            accesoriosGrid = accesorios.Where(a => a.Categoria == EnumCategorias.Cerradura).ToList();
            ActualizarGrilla();
        }
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            if (!editando)
            {
                Accesorio acc = new Accesorio(textBoxCodigo.Text, textBoxNombre.Text, Convert.ToInt16(numericSuletos.Value), Convert.ToInt16(numericBolsas.Value), textBoxDescripcion.Text, EnumCategorias.Cerradura);
                accesorios.Add(acc);
                ActualizarGrilla();
            }
            else if (editando)
            {
                Accesorio m = new Accesorio(textBoxCodigo.Text, textBoxNombre.Text, Convert.ToInt16(numericSuletos.Value), Convert.ToInt16(numericBolsas.Value), textBoxDescripcion.Text, EnumCategorias.Cerradura);
                accesorios[indice] = m;
        ...
        private void FormCerraduras_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                accesorios.Remove(accesorios.Where(a => a.Codigo == dataGridViewCerradura.CurrentRow.Cells[0].Value.ToString()).SingleOrDefault());
                accesoriosGrid = accesorios.Where(a => a.Categoria == EnumCategorias.Cerradura).ToList();
                LimpiarCampos();
                ActualizarGrilla();
            }
        ...
        private void textBoxBuscar_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                accesoriosGrid = accesorios.Where(a => a.Categoria == EnumCategorias.Cerradura).ToList().Where(b => b.Codigo.Contains(textBoxBuscar.Text.Trim().ToUpper()) || b.Nombre.Contains(textBoxBuscar.Text.Trim()) || b.Descripcion.Contains(textBoxBuscar.Text.Trim()) || b.CantidadBolsas == n || b.CantidadSuelta == n).ToList();

            }
            else
            {
                accesoriosGrid = accesorios.Where(a => a.Categoria == EnumCategorias.Cerradura).ToList().Where(b => b.Codigo.Contains(textBoxBuscar.Text.Trim().ToUpper()) || b.Nombre.Contains(textBoxBuscar.Text.Trim()) || b.Descripcion.Contains(textBoxBuscar.Text.Trim())).ToList();
            }
            ActualizarGrilla();
        }
