...
namespace RM_v2.Forms
{
    public partial class FormEscuadras : Form
    {
        ...
        private async void ActualizarGrilla()
        {
            ...
            accesorios = await _dbContext.accesorios.Where(a => a.Categoria == EnumCategorias.Escuadra).ToArrayAsync();
            if (accesorios is not null)
            {
                dataGridViewEscuadras.DataSource = null;
                dataGridViewEscuadras.DataSource = accesorios;
            }
        }
                ...
                if (accesorios is not null)
                {
                    if (!editando)
                    {
                        ...
                        Accesorio accesorio = new Accesorio()
                        {
                            ...
                            Categoria = EnumCategorias.Escuadra,
                        };
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                Accesorio? acc = _dbContext.accesorios.Where(a => a.Codigo == dataGridViewEscuadras.CurrentRow.Cells[0].Value.ToString()).SingleOrDefault();
                if (acc is not null)
                {
        ...
        private void textBoxBuscar_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                accesorios = _dbContext.accesorios.Where(a => a.Categoria == EnumCategorias.Escuadra).ToList().Where(b => b.Codigo.Contains(textBoxBuscar.Text.Trim().ToUpper()) || b.Nombre.Contains(textBoxBuscar.Text.Trim()) || b.Descripcion.Contains(textBoxBuscar.Text.Trim()) || b.CantidadBolsas == n || b.CantidadSuelta == n).ToArray();
                if (accesorios is not null)
                {
                    dataGridViewEscuadras.DataSource = null;
                    dataGridViewEscuadras.DataSource = accesorios;
            ...
            {
                accesorios = _dbContext.accesorios.Where(a => a.Categoria == EnumCategorias.Escuadra).ToList().Where(b => b.Codigo.Contains(textBoxBuscar.Text.Trim().ToUpper()) || b.Nombre.Contains(textBoxBuscar.Text.Trim()) || b.Descripcion.Contains(textBoxBuscar.Text.Trim())).ToArray();
                if (accesorios is not null)
                {
                    dataGridViewEscuadras.DataSource = null;
                    dataGridViewEscuadras.DataSource = accesorios;
