namespace RM_v2.Forms
{
    partial class FormOtros
    {
        ...
        private void InitializeComponent()
        {
            ...
            dataGridViewOtro = new DataGridView();
            ...
            ((System.ComponentModel.ISupportInitialize)dataGridViewOtro).BeginInit();
            ...
            panelGrid.Controls.Add(dataGridViewOtro);
            ...
            // dataGridViewOtro
            // 
            dataGridViewOtro.AllowUserToAddRows = false;
            dataGridViewOtro.AllowUserToDeleteRows = false;
            dataGridViewOtro.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            dataGridViewOtro.AutoGenerateColumns = false;
            dataGridViewOtro.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dataGridViewOtro.BackgroundColor = Color.White;
            dataGridViewOtro.BorderStyle = BorderStyle.None;
            dataGridViewOtro.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.Single;
            dataGridViewOtro.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dataGridViewOtro.Columns.AddRange(new DataGridViewColumn[] { codigoDataGridViewTextBoxColumn, nombreDataGridViewTextBoxColumn, cantidadSueltaDataGridViewTextBoxColumn, cantidadBolsasDataGridViewTextBoxColumn, descripcionDataGridViewTextBoxColumn });
            dataGridViewOtro.DataSource = accesorioBindingSource;
            dataGridViewOtro.Location = new Point(51, 71);
            dataGridViewOtro.Margin = new Padding(3, 4, 3, 4);
            dataGridViewOtro.Name = "dataGridViewOtro";
            dataGridViewOtro.ReadOnly = true;
            dataGridViewOtro.RowHeadersWidth = 51;
            dataGridViewOtro.RowTemplate.Height = 24;
            dataGridViewOtro.Size = new Size(985, 266);
            dataGridViewOtro.TabIndex = 24;
            dataGridViewOtro.RowHeaderMouseDoubleClick += dataGridViewOtro_RowHeaderMouseDoubleClick;
            // 
            ...
            label5.Location = new Point(897, 42);
            label5.Name = "label5";
            ...
            label4.Location = new Point(897, 109);
            label4.Name = "label4";
            ...
            numericSuletos.Location = new Point(897, 65);
            ...
            numericBolsas.Location = new Point(897, 132);
            ...
            textBoxDescripcion.Location = new Point(51, 131);
            ...
            textBoxNombre.Location = new Point(307, 61);
            ...
            textBoxCodigo.Location = new Point(51, 61);
            ...
            btnLimpiar.Location = new Point(51, 218);
            ...
            btnEliminar.Location = new Point(907, 218);
            ...
            btnAgregar.Location = new Point(773, 218);
            ...
            ((System.ComponentModel.ISupportInitialize)dataGridViewOtro).EndInit();
        ...
        private DataGridView dataGridViewOtro;
