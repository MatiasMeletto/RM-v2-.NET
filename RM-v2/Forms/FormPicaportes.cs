    ...
    public partial class FormPicaportes : Form
    {
        ...
        private async void ActualizarGrilla()
        {
            ...
            if (accesorios is not null)
            {
                ...
                dataGridViewPicaportes.DataSource = accesorios;
            }
        }
                ...
                if (accesorios is not null)
                {
                    if (!editando)
                    {
                        ...
                        Accesorio accesorio = new Accesorio()
                        {
                            ...
                            Categoria = EnumCategorias.Picaporte,
                        };
        ...
        private void textBoxBuscar_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                accesorios = _dbContext.accesorios.Where(a => a.Categoria == EnumCategorias.Picaporte).ToList().Where(b => b.Codigo.Contains(textBoxBuscar.Text.Trim().ToUpper()) || b.Nombre.Contains(textBoxBuscar.Text.Trim()) || b.Descripcion.Contains(textBoxBuscar.Text.Trim()) || b.CantidadBolsas == n || b.CantidadSuelta == n).ToArray();
                if (accesorios is not null)
                {
                    dataGridViewPicaportes.DataSource = null;
                    dataGridViewPicaportes.DataSource = accesorios;
            ...
            {
                accesorios = _dbContext.accesorios.Where(a => a.Categoria == EnumCategorias.Picaporte).ToList().Where(b => b.Codigo.Contains(textBoxBuscar.Text.Trim().ToUpper()) || b.Nombre.Contains(textBoxBuscar.Text.Trim()) || b.Descripcion.Contains(textBoxBuscar.Text.Trim())).ToArray();
                if (accesorios is not null)
                {
                    dataGridViewPicaportes.DataSource = null;
                    dataGridViewPicaportes.DataSource = accesorios;
