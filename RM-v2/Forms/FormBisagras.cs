...
namespace RM_v2.Forms
{
    public partial class FormBisagras : Form
    {
        ...
        private async void ActualizarGrilla()
        {
            ...
            accesorios = await _dbContext.accesorios.Where(a => a.Categoria == EnumCategorias.Bisagra).ToArrayAsync();
            if (accesorios is not null)
            {
                dataGridViewBisagras.DataSource = null;
                dataGridViewBisagras.DataSource = accesorios;
            }
        }
                ...
                if (accesorios is not null)
                {
                    if (!editando)
                    {
                        ...
                        Accesorio accesorio = new Accesorio()
                        {
                            ...
                            Categoria = EnumCategorias.Bisagra
                        };
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                Accesorio? acc = _dbContext.accesorios.Where(a => a.Codigo == dataGridViewBisagras.CurrentRow.Cells[0].Value.ToString()).SingleOrDefault();
                if (acc is not null)
                {
        ...
        private void textBoxBuscar_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                accesorios = _dbContext.accesorios.Where(a => a.Categoria == EnumCategorias.Bisagra).ToList().Where(b => b.Codigo.Contains(textBoxBuscar.Text.Trim().ToUpper()) || b.Nombre.Contains(textBoxBuscar.Text.Trim()) || b.Descripcion.Contains(textBoxBuscar.Text.Trim()) || b.CantidadBolsas == n || b.CantidadSuelta == n).ToArray();
                if (accesorios is not null)
                {
                    dataGridViewBisagras.DataSource = null;
                    dataGridViewBisagras.DataSource = accesorios;
            ...
            {
                accesorios = _dbContext.accesorios.Where(a => a.Categoria == EnumCategorias.Bisagra).ToList().Where(b => b.Codigo.Contains(textBoxBuscar.Text.Trim().ToUpper()) || b.Nombre.Contains(textBoxBuscar.Text.Trim()) || b.Descripcion.Contains(textBoxBuscar.Text.Trim())).ToArray();
                if (accesorios is not null)
                {
                    dataGridViewBisagras.DataSource = null;
                    dataGridViewBisagras.DataSource = accesorios;
