namespace RM_v2.Forms
{
    partial class FormCerraduras
    {
        ...
        private void InitializeComponent()
        {
            ...
            dataGridViewCerradura = new DataGridView();
            ...
            ((System.ComponentModel.ISupportInitialize)dataGridViewCerradura).BeginInit();
            ...
            panelGrid.Controls.Add(dataGridViewCerradura);
            ...
            // 
            dataGridViewCerradura.AllowUserToAddRows = false;
            dataGridViewCerradura.AllowUserToDeleteRows = false;
            dataGridViewCerradura.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            dataGridViewCerradura.AutoGenerateColumns = false;
            dataGridViewCerradura.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dataGridViewCerradura.BackgroundColor = Color.White;
            dataGridViewCerradura.BorderStyle = BorderStyle.None;
            dataGridViewCerradura.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.Single;
            dataGridViewCerradura.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dataGridViewCerradura.Columns.AddRange(new DataGridViewColumn[] { codigoDataGridViewTextBoxColumn, nombreDataGridViewTextBoxColumn, cantidadSueltaDataGridViewTextBoxColumn, cantidadBolsasDataGridViewTextBoxColumn, descripcionDataGridViewTextBoxColumn });
            dataGridViewCerradura.DataSource = accesorioBindingSource;
            dataGridViewCerradura.Location = new Point(52, 71);
            dataGridViewCerradura.Margin = new Padding(3, 4, 3, 4);
            dataGridViewCerradura.Name = "dataGridViewCerradura";
            dataGridViewCerradura.ReadOnly = true;
            dataGridViewCerradura.RowHeadersWidth = 51;
            dataGridViewCerradura.RowTemplate.Height = 24;
            dataGridViewCerradura.Size = new Size(984, 267);
            dataGridViewCerradura.TabIndex = 24;
            dataGridViewCerradura.RowHeaderMouseDoubleClick += dataGridViewCerraduras_RowHeaderMouseDoubleClick;
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)dataGridViewCerradura).EndInit();
        ...
        private DataGridView dataGridViewCerradura;
